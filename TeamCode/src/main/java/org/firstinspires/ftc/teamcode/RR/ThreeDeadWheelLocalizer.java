...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -13300; // y position of the first parallel encoder (in tick units)11992.185240442053
        public double par1YTicks = 13300; // y position of the second parallel encoder (in tick units)13579.93314378358
        public double perpXTicks = -5000; // x position of the perpendicular encoder (in tick units)
    }
